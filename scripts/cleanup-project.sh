...
kubectl delete svc currency-3rdparty-service
kubectl delete svc currency-service
...
docker rmi sidartasilva/currency-3rdparty-service:latest
docker rmi sidartasilva/currency-service:latest
