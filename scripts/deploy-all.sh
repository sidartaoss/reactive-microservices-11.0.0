...
sleep 20;
kubectl apply -f deployment-currency-3rdparty-service.yaml
kubectl apply -f deployment-currency-service.yaml
sleep 20;
kubectl apply -f ingress-currency-service.yaml
kubectl apply -f ingress-currency-3rdparty-service.yaml
echo ""
