...
kubectl delete svc quote-generator micro-trader-dashboard portfolio-service compulsive-traders audit-database audit-service currency-3rdparty-service currency-service
