    ...
    public void start(Future<Void> future) {
        ...
        retriever.rxGetConfig()
            ...
            Record record1 = HttpEndpoint.createRecord(
                "quote-generator-market", // The service name
                "quote-generator-reactive-microservices.sidartasilva.io" // The host
              );

            discovery.publish(record1, ar -> {
                if (ar.succeeded()) {
                    System.out.println("\n\nSuccess in publishing quote-generator\n\n");
                } else {
                    System.err.println("\n\nError in publishing quote-generator.\n\n");
                    if (ar.cause() != null) {
